    ...
    <div class="outer9">
      ...
      <div class="inter2">
        <div class="inter21">
          ...
          <span class="count">数量</span><span class="total">小计</span
          ...
          <ul>
            <li>
              <input type="checkbox" class="check" /><img
                ...
                alt=""
              />
              <span class="s1">经典系列红色时钟</span
              ><span class="money">¥</span> <span class="price">580</span
            ...
            <li>
              <input type="checkbox" class="check" /><img
                ...
                alt=""
              />
              <span class="s1">黑色陶瓷研磨器皿</span>
              <span class="money">¥</span> <span class="price">150</span
              ><input type="button" value="-" class="sub" />
              <span class="count">1</span
              ><input type="button" value="+" class="add" />
      ...
      <div class="inter3">
        <div class="inter31">
          ...
          <div class="foot">
            已选<span class="totalCount">0</span>件 合计(不含运费) :
            <span class="totalPrice">¥0</span>元<br />
